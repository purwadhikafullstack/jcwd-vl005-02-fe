...
export default function UserInvoice() {
  ...
  useEffect(() => {
    let fetchCart = `/user/checkout/${userId}/get-invoice`;
  ...
  const submitHandler = (event) => {
    ...
    axios
      .post(URL_API + `/user/checkout/${userId}/upload/${invoiceId}`, formData)
      .then((res) => {
        console.log(res);
        setLoading(false);
        setAddFile(null);
    ...
    <>
      <Container maxW={"7xl"} py={12} px={10}>
        ...
        <Box borderRadius={"lg"} bg={useColorModeValue("gray.50", "gray.800")}>
          ...
          >
            ...
            >
              <Text>AMOUNT</Text>
              <Text fontWeight="400">
                Rp {data.length && data[0].total_payment}
              </Text>
        ...
        <Button
          ...
          color={useColorModeValue("white", "red.900")}
